package com.raccoon.peruvende.ecomerce.utility;
...
public class ImageUrlUtils {
    ...
    public void addCartListImageUri(ProductModel wishlistImageUri) {
        this.productModels.add(0,wishlistImageUri);
    }
    ...
    public void removeItemCart(int position) {
        this.productModels.remove(position);
    }
    ...
    public Double calculatetotal() {
        ...
        double total = 0;
        for (int i = 0; i < this.getProductModels().size(); i++) {

            total = total + this.getProductModels().get(i).getPrice();
        }
