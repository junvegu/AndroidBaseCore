...
public class AccesoriesFragment extends Fragment {
    ...
    public void loadOferts() {
        ...
        Call<BaseModel<ArrayList<ProductModel>>> call = loginService.getAccesories(BussinesModel.token,BussinesModel.id);
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
      /*  if (ImageListFragment.this.getArguments().getInt("type") == 1) {
        ...
        String[] items = null;
        if (AccesoriesFragment.this.getArguments().getInt("type") == 1) {
            items = ImageUrlUtils.getOffersUrls();
        } else if (AccesoriesFragment.this.getArguments().getInt("type") == 2) {
            items = ImageUrlUtils.getElectronicsUrls();
        } else if (AccesoriesFragment.this.getArguments().getInt("type") == 3) {
            items = ImageUrlUtils.getLifeStyleUrls();
        } else if (AccesoriesFragment.this.getArguments().getInt("type") == 4) {
            items = ImageUrlUtils.getHomeApplianceUrls();
        } else if (AccesoriesFragment.this.getArguments().getInt("type") == 5) {
